            ...
            <div class="container">
               ...
               <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                  ...
                  <div class="owl-carousel owl-theme c-theme owl-bordered1 c-owl-nav-center" data-items="6" data-desktop-items="4" data-desktop-small-items="3" data-tablet-items="3" data-mobile-items="2" data-slide-speed="5000" data-rtl="false">
                     <div class="item">
                        <a href="{{route('services')}}" ><img src="{{asset('frontend/images/7.jpg')}}" alt="Trang cá nhân nickvn"/></a>
                     </div>
                     <div class="item">
                        <a href="{{route('services')}}" ><img src="{{asset('frontend/images/vHPm7XyQah_1623147701.jpg')}}" alt="Trang cá nhân nickvn"/></a>
                     </div>
                     <div class="item">
                        <a href="{{route('services')}}" ><img src="{{asset('frontend/images/vHPm7XyQah_1623147701.jpg')}}" alt="Trang cá nhân nickvn"/></a>
                     </div>
                     ...
                     <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                           <div class="news_image">
                              ...
                              <a href="{{route('category')}}" title="{{$category->title}}" class="">
                              <img src="{{asset('/uploads/category/'.$category->image)}}" alt="{{$category->title}}"></a>
                           </div>
                           <div class="news_title">
                              <h2>
                                 <a href="{{route('category')}}" title="{{$category->title}}">{{$category->title}}</a>
                              </h2>
                           </div>
                              ...
                              <div class="row">
                                 <div class="col-xs-12">
                                    <div class="custom72 view">
                                       <a href="#" class="" title="{{$category->title}}">
                                          &nbsp;
